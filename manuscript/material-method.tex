...
Cells come from tumours of 20 patients diagnosed with glioblastoma, they were then cultured \textit{in vitro} before RNA-Seq analysis was conducted.
...
Both tools give as an output a list of pathways with a p-value associated to each pathways.
...
\begin{figure}
    ...
    \caption{
        ...
        The bottom panel describes the workflow adopted to assess the specific deregulations of each samples in both datasets : a personalized analysis.
