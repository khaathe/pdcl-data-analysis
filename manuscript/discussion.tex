...
Our workflow starts with a \acrlong{de} analysis where we compare the gene expression of samples belonging to one condition with a control condition (usually a normal sample).
